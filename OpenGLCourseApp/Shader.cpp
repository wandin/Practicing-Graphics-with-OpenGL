...
void Shader::SetDirectionalLight(DirectionalLight* dLight)
{
	if (dLight)
	{
		dLight->UseLight(uniformDirectionLight.uniformAmbientIntensity, uniformDirectionLight.uniformColour,
...
void Shader::SetSpotLights(SpotLight* sLight, unsigned int lightCount)
{
	...
	for (size_t i = 0; i < lightCount; i++)
	{
		sLight[i].UseLight(uniformSpotLight[i].uniformAmbientIntensity, uniformSpotLight[i].uniformColour,uniformSpotLight[i].uniformDiffuseIntensity,								  uniformSpotLight[i].uniformPosition, uniformSpotLight[i].uniformDirection,
